...
function Header({islogin}) {
    return (<div>
        <Navbar style={{borderBottom:"2px solid #d1cdcd",paddingTop:"10px"}} collapseOnSelect expand="lg" bg="light" variant="light">
         <Navbar.Brand href="/"><div style={{flexDirection:"row",display:"flex",marginLeft:"10px"}}>
         ...
         {(islogin)?  <Nav style={{marginLeft:"auto"}}>
               <NavLink style={{marginRight:"15px"}} exact activeClassName="activebutton2"  className="nav-link h6"  to="/upload">Upload</NavLink>
         <button style={{marginRight:"15px"}} className="followbutton">Logout</button>
           </Nav>:null}
         </Navbar.Collapse>
       </Navbar>
